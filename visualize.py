...
def visualize(start, goal, boat, x, y, min_index, wind_direction_vector, new_heading, goal_vector, lake):
    ...
    plt.arrow(goal[0], goal[1], wind_direction_vector[0] * arrow_scale, wind_direction_vector[1] * arrow_scale,
              width=0.0005, length_includes_head=True, label="Wind direction", fc='blue')
    ...
    plt.arrow(boat[0], boat[1], goal_vector[0] * arrow_scale, goal_vector[1] * arrow_scale,
              width=0.0005, length_includes_head=True, label="Goal vector", fc='red')
    ...
    plt.arrow(boat[0], boat[1], new_heading[0] * arrow_scale, new_heading[1] * arrow_scale,
              width=0.0005, length_includes_head=True, label="New heading", fc='green')
